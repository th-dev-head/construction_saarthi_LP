...
const Hero = ({ scrollToSection }) => {
  return (
    <section id="home" className="relative flex flex-col items-center justify-center py-20 px-4 md:p-[100px] xl:p-[180px] 2xl:p-[212px] mb-20">
      ...
      {/* CONTENT */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 text-center text-white flex flex-col items-center">
        {/* Product Tag */}
        ...
        {/* Heading */}
        <h1 className="text-xl md:text-[35px] xl:text-5xl 2xl:text-[60px] font-semibold mb-3 md:mb-2 tracking-[0.02em]">
        ...
        {/* Description */}
        <p className="max-w-2xl mx-auto text-xs md:text-sm lg:text-base opacity-90 mb-10 md:mb-12 font-light leading-relaxed">
      ...
      {/* STATS FLOATING CARD */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-[94%] max-w-xl lg:max-w-2xl xl:max-w-4xl z-20">
        <div className="bg-[#F9F4EE] rounded-[20px] p-5 border border-[#F4EEE6] overflow-hidden grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-0">
          {/* Stat 1 */}
